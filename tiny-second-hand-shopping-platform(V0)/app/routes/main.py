...
from ..models import Message, Product, Transfer, User
from ..utils import active_user_required, sanitize_text, withdraw_user_account
...
def index():
    ...
    return render_template("index.html", products=recent_products, stats=stats)
...
def user_detail(user_id):
    ...
    return render_template(
        "profile/user_detail.html", profile_user=user, products=products
    )
